        ...
        but_quiz1.setOnClickListener(
                new View.OnClickListener(){
                    ...
                    public void onClick(View v){
                        ...
                        AlertDialog.Builder alertDlg = new AlertDialog.Builder(Quiz1.this);
                        ...
                        alertDlg.setPositiveButton("yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                String answer = "Red + White";

                                if (rad_b.getText().toString().equals(answer)){

                                    String q1 = "Question 1: Correct ~ "+answer;

                                    Toast.makeText(Quiz1.this,q1,Toast.LENGTH_SHORT).show();
                                    //Saves user input
                                    SharedPreferences sp = getSharedPreferences("MyPref", Context.MODE_PRIVATE);
                                    SharedPreferences.Editor editor = sp.edit();
                                    editor.putString("QUIZRESULT1",q1);
                                    editor.commit();
